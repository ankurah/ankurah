...
impl ModelDescription {
    ...
    /// Internal models can opt out of generated WASM/UniFFI surface while
    /// retaining the same Rust schema and typed view/mutable implementations.
    pub fn no_ffi(&self) -> bool { get_model_flag(&self.struct_attrs, "no_ffi") }
