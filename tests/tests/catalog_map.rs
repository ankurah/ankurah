...
fn forged_model_delta(collection: &str) -> (EntityId, proto::ModelContext<proto::Attested<proto::EntityState>>, proto::EntityDelta) {
    ...
    (entity_id, proto::ModelContext::new(model, state), delta)
}
