...
fn forged_model_delta(collection: &str) -> (EntityId, proto::Attested<proto::EntityState>, proto::EntityDelta) {
    ...
    backend.set(PropertyId::System { name: "name".to_owned() }, Some(Value::String("Stale generation".to_owned())));
    ...
    let model = proto::ModelId::WellKnown(proto::WellKnownModel::Model);
    ...
    storage
        .set_state(proto::Attested::opt(
            proto::EntityState {
                ...
                model: proto::ModelId::Entity(proto::EntityId::new()),
