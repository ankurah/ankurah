...
use ankurah::core::property::{read_by_id, FromEntity};
...
fn membership_genesis(model: &EntityId, property: &EntityId) -> proto::Event {
    ...
    let mut event = proto::Event {
        ...
        operations: proto::OperationSet::from_backends(BTreeMap::from([("lww".to_string(), operations)])),
        parent: proto::Clock::default(),
    };
    event.operations.push(proto::Operation::Membership(proto::Membership::Add(proto::ModelId::System(proto::SystemModel::ModelProperty))));
    event
}
