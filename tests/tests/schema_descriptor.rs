...
fn catalog_event_context(collection: &str, mut event: proto::Event) -> proto::Attested<proto::Event> {
    ...
    if event.is_entity_create() {
        event.operations.push(proto::Operation::Membership(proto::Membership::Add(model)));
    }
