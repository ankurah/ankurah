...
//! - **Materialization**: A model-specific projection used for querying and indexing
...
//! - Entity ids are the hash of the entity's genesis event; correlation ids are ULIDs
