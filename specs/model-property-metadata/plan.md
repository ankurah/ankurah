...
2. **Presence field appended last** for the original v1 transition. Superseded
   at v6 as described in the amendment above; stable outer discriminants and
   exact bounded decoding now prevent cross-version prefix confusion.
