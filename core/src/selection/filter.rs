...
fn evaluate_expr<I: Filterable>(item: &I, expr: &Expr) -> Result<ExprOutput<Value>, Error> {
    match expr {
        ...
        // A RESOLVED PropertyPath addresses exactly one property by durable
        // identity plus an optional JSON sub-path. It does NOT share
        ...
        // qualifier. Its label is display-only and never a read fallback.
