...
pub enum PropertyError {
    ...
    /// (core/src/schema/resolve.rs) rather than handing a half-supported
    /// reference to a planner or comparator.
    #[error("unsupported subpath '{path}' in collection '{collection}': {reason}")]
    UnsupportedSubpath { collection: String, path: String, reason: String },
