//! Which column Postgres reads a resolved property from.
...
///
/// This is Postgres's own seam, deliberately not shared with the other
/// engines: the engine-side catalog resolver replaces this rendering with the
/// physical column name this engine assigned the property.
