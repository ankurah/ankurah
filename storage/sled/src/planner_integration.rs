...
/// Type-aware component encoding without type tags - requires KeySpec<String> for type validation
...
/// Type-aware encoding using KeySpec<String> for validation and optimization
/// Delegates to core encoding for consistency
